...
from .correction_types import Correction, CorrectionResult
...
class AutoCorrector:
    ...
    def correct_list(self, texts: List[str]) -> CorrectionResult:
        """Sửa lỗi cho danh sách text (khuyến nghị dùng)"""
        if not self.enabled:
        ...
        # Bước 2: Dictionary-based
        current_texts, dict_corrections = self.dict_corrector.correct(current_texts)
